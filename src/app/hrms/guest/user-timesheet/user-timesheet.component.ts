...
import { TaskName, TimeSheetDetail, taskTypeOptions, RequestDto } from 'src/app/common/datatypes/DataTypes';
import { TimeSheetStatus, Api } from 'src/app/common/enum/enum';
...
export default class UserTimesheetComponent {
  ...
  async ngOnInit() {
    this.employeeId = Number((await this.authService.decodeObjectFromBase64(localStorage.getItem('jwt'))).employeeId);

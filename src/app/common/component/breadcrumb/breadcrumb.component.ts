...
import { NavigationItem } from 'src/app/common/component/layouts/admin/navigation/navigation';
...
export class BreadcrumbComponent {
  ...
  jwtDecode() {
    this.navigation = this.nav.get(this.AuthService.decodeObjectFromBase64(localStorage.getItem('jwt'))['role']);
  }

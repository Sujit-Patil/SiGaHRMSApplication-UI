...
import { HrComponent } from './theme/layouts/hr/hr.component';
...
@NgModule({
  ...
  imports: [BrowserModule, AppRoutingModule, SharedModule, BrowserAnimationsModule, HttpClientModule, DatePipe],
  providers: [
    NavigationItem,
    DatePipe,
    {
